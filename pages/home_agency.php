    ...
    <div class="hero-3" id="hero">
        <div class="swiper hero-slider-3" id="heroSlide3">
            <div class="swiper-wrapper">
                    ...
                    <div class="hero-inner">
                        ...
                        <div class="container">
                            <div class="hero-style3">
                                ...
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Tourm an international
                                    travel management company with 25 years of
                                    experience, specializing in business and maritime travel.</p>
                                <div class="btn-group" data-ani="slideinup" data-ani-delay="0.6s">
                                    <a href="index.php?page=destination" class="th-btn style2 th-icon">Explore Tours</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_3_2.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style3">
                                <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                    discover The world best destination
                                </h1>
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Tourm an international
                                    travel management company with 25 years of
                                    experience, specializing in business and maritime travel.</p>
                ...
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_3_4.jpg">
                        </div>
                        <div class="container">
                            <div class="hero-style3">
                                <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.2s">
                                    Explore the world with Tourm
                                </h1>
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.4s">Tourm an international
                                    travel management company with 25 years of
                                    experience, specializing in business and maritime travel.</p>
                ...
                <div class="row justify-content-center align-items-end flex-row-reverse">
                    <div class="col-lg-4">
                        <div class="hero3-swiper-custom">
                            <button data-slider-prev="#heroSlide3" class="swiper-button-next">
                                <img src="assets/img/icon/hero-arrow-right.svg" alt=""></button>
                            <div class="swiper-pagination"></div>
                            <button data-slider-next="#heroSlide3" class="swiper-button-prev">
                                <img src="assets/img/icon/hero-arrow-left.svg" alt=""></button>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero3-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_bg_3_1.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero3-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_bg_3_2.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero3-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_bg_3_3.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero3-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_bg_3_4.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="hero-inner">
                                        <div class="hero3-card">
                                            <div class="hero-img">
                                                <img src="assets/img/hero/hero_bg_3_5.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="hero-booking">
                            <form action="mail.php" method="POST" class="booking-form style2 ajax-contact">
        ...
        <div class="scroll-down">
            <a href="#destination-sec" class="scroll-wrap"><span><img src="assets/img/icon/down-arrow.svg" alt=""></span> Scroll
                Down</a>
        </div>
    </div>
    <!--======== / Hero Section ========--><!--==============================
...
==============================-->
    ...
    <section class="position-relative overflow-hidden space" id="destination-sec" data-bg-src="assets/img/bg/line-pattern3.png">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-5">
                    ...
                    <p class="sec-text mb-30">One of the most well-liked travel companies for people looking to experience
                        adventure and see the world is Tourm.</p>
                ...
                <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"2"},"1200":{"slidesPerView":"3"},"1300":{"slidesPerView":"4"}}}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-item th-ani">
                                <div class="destination-item_img global-img">
                                    <img src="assets/img/destination/destination_3_1.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="index.php?page=destination_details">Dubai, UAE</a></h3>
                                    <p class="destination-text">25 Listing</p>
                                    <a href="index.php?page=destination_details" class="th-btn style4 th-icon">Book Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item th-ani">
                                <div class="destination-item_img global-img">
                                    <img src="assets/img/destination/destination_3_2.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="index.php?page=destination_details">Japan</a></h3>
                                    <p class="destination-text">25 Listing</p>
                                    <a href="index.php?page=destination_details" class="th-btn style4 th-icon">Book Now</a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item th-ani">
                                <div class="destination-item_img global-img">
                                    <img src="assets/img/destination/destination_3_3.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="index.php?page=destination_details">Switzerland</a></h3>
                                    <p class="destination-text">25 Listing</p>
                                    <a href="index.php?page=destination_details" class="th-btn style4 th-icon">Book Now</a>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="destination-item th-ani">
                                <div class="destination-item_img global-img">
                                    <img src="assets/img/destination/destination_3_4.jpg" alt="image">
                                </div>
                                <div class="destination-content">
                                    <h3 class="box-title"><a href="index.php?page=destination_details">Brazil</a></h3>
                                    <p class="destination-text">25 Listing</p>
                                    <a href="index.php?page=destination_details" class="th-btn style4 th-icon">Book Now</a>
                                </div>
                            </div>
            ...
            <div class="destination-btn text-center mt-60">
                <a href="index.php?page=destination" class="th-btn style3 th-icon">View All</a>
            </div>
        </div>
    </section><!--==============================
Category Area  
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="category-card single2">
                                ...
                                <h3 class="box-title"><a href="index.php?page=destination">Cruises</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card single2">
                                ...
                                <h3 class="box-title"><a href="index.php?page=destination">Hiking</a></h3>
                                <a class="line-btn" href="index.php?page=destination">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card single2">
                                ...
                                <h3 class="box-title"><a href="index.php?page=destination">Airbirds</a></h3>
                                <a class="line-btn" href="index.php?page=destination">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card single2">
                                ...
                                <h3 class="box-title"><a href="index.php?page=destination">Wildlife</a></h3>
                                <a class="line-btn" href="index.php?page=destination">See more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="category-card single2">
                                ...
                                <h3 class="box-title"><a href="index.php?page=destination">Walking</a></h3>
                                <a class="line-btn" href="index.php?page=destination">See more</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-5">
                    <div class="ps-xl-4">
                        ...
                        <p class="sec-text mb-30">There are many variations of passages of available but the majority have suffered alteration in some form, by injected hum randomised words.</p>
                        ...
                        <div class="mt-35"><a href="index.php?page=about" class="th-btn style3 th-icon">Learn More</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="position-relative bg-top-center overflow-hidden space" id="service-sec" data-bg-src="assets/img/bg/tour_bg_1.jpg">
        <div class="container">
            ...
            <div class="nav nav-tabs tour-tabs" id="nav-tab" role="tablist">
                <button class="nav-link th-btn active" id="nav-step1-tab" data-bs-toggle="tab" data-bs-target="#nav-step1" type="button"><img src="assets/img/icon/tour_icon_1.svg" alt="">Tour Package</button>
                <button class="nav-link th-btn" id="nav-step2-tab" data-bs-toggle="tab" data-bs-target="#nav-step2" type="button"><img src="assets/img/icon/tour_icon_2.svg" alt="">Hotel</button>
                <button class="nav-link th-btn" id="nav-step3-tab" data-bs-toggle="tab" data-bs-target="#nav-step3" type="button"><img src="assets/img/icon/tour_icon_3.svg" alt="">Transport</button>
            </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Greece Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        ...
                                                        Rating)</span></div>
                                                <a href="index.php?page=tour_details" class="woocommerce-review-link">(<span class="count">4.8</span>
                                                    Rating)</a>
                                            </div>
                                            <h4 class="tour-box_price"><span class="currency">$980.00</span>/Person</h4>
                                            <div class="tour-action">
                                                <span><i class="fa-light fa-clock"></i>7 Days</span>
                                                <a href="index.php?page=tour_details" class="th-btn style4 th-icon">Book Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Italy Tour package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Dubai Tour Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Switzerland</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                        ...
                        <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_5.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">The Plaza, New York</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_6.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Hotel Ritz Paris</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_7.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Claridge’s, London</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_8.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Taj Mahal Palace, India</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_9.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Peninsula Hong Kong</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_10.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">The Ritz Hotel London</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_11.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">The Shelbourne Hotel, Dublin</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_12.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Beverly Hills Hotel</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                        ...
                        <div class="swiper th-slider has-shadow" data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"576":{"slidesPerView":"1"},"768":{"slidesPerView":"2"},"992":{"slidesPerView":"3"},"1200":{"slidesPerView":"3"},"1400":{"slidesPerView":"4"}}}'>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_13.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Caravan Trip Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_14.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Sleeper Buses Package </a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_15.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Trips by Train Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_16.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Travel by Air Flight Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_17.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Cruise Transports Package</a></h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8
                                                        Rating)</span></div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_18.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Travel by Air Flight Package</a></h3>
                                            <div class="tour-rating">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_19.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Sleeper Buses Package </a></h3>
                                            <div class="tour-rating">
                                ...
                                <div class="swiper-slide">
                                    <div class="tour-box th-ani gsap-cursor">
                                        <div class="tour-box_img global-img">
                                            <img src="assets/img/tour/tour_box_20.jpg" alt="image">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title"><a href="index.php?page=tour_details">Trips by Train Package</a></h3>
                                            <div class="tour-rating">
                ...
                <div class="col-lg-6">
                    <div class="contact-form-area">
                        ...
                        <div class="form-btn-wrapp">
                            <div class="form-btn">
                                <button class="th-btn white-btn">Send Message <img src="assets/img/icon/plane3.svg" alt=""></button>
                            </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testi-grid">
                                    ...
                                    <div class="testi-grid_content">
                                        <p class="testi-grid_text">“A home that perfectly blends sustainability with luxury until discovered Ecoland Residence. The moment I stepped community, I knew it was where I wanted to live.”</p>
                                        <h6 class="testi-grid_name box-title">Andrew Simon</h6>
                                        <span class="testi-grid_desig">Traveller</span>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-grid">
                                    ...
                                    <div class="testi-grid_content">
                                        <p class="testi-grid_text">“The home boasts sleek, contemporary architecture with clean lines and expansive windows, allowing natural light to flood the interiors It incorporates passive design principles”</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-grid">
                                    ...
                                    <div class="testi-grid_content">
                                        <p class="testi-grid_text">“Solar panels adorn the roof, harnessing renewable energy to power the home and even feed excess electricity back into the grid. High-performance insulation and triple-glazed”</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-grid">
                                    ...
                                    <div class="testi-grid_content">
                                        <p class="testi-grid_text">A sophisticated rainwater harvesting system collects and filters rainwater for irrigation and non-potable uses, reducing reliance on municipal water sources. Greywater systems</p>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-grid">
                                    ...
                                    <div class="testi-grid_content">
                                        <p class="testi-grid_text">Throughout the interior, eco-friendly materials like reclaimed wood, bamboo flooring, and recycled glass countertops create a luxurious yet sustainable ambiance.</p>
            ...
            <div class="row justify-content-lg-between justify-content-center align-items-end">
                <div class="col-lg">
                    <div class="title-area text-center text-lg-start">
                        ...
                        <h2 class="sec-title">Blog & Articles From Tourm</h2>

                    </div>
                </div>
                <div class="col-lg-auto d-none d-lg-block">
                    <div class="sec-btn">
                        <a href="index.php?page=blog" class="th-btn style4 th-icon">See More Articles</a>
                    </div>
                </div>
            </div>
