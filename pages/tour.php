                                            ...
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                    <span style="width:100%">Rated
                                                        <strong class="rating">5.00</strong> out of 5 based on <span class="rating"><?php echo htmlentities($result->PackageRate);?></span>(<?php echo htmlentities($result->PackageRate);?>
                                                        Rating)</span>
                                                </div>
                                        ...
                                        <div class="tour-content">
                                            ...
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated
                                                        <strong class="rating">3.00</strong> out of 5 based on <span class="rating">3.8</span>(3.8
                                                        Rating)</span></div>
