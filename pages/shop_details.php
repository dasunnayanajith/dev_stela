                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <div class="product-rating">
                            ...
                            <a href="index.php?page=shop_details" class="woocommerce-review-link">(<span class="count">4</span>
                                customer reviews)</a>
                        </div>
                        ...
                        <div class="actions">
                            ...
                            <a href="index.php?page=wishlist" class="icon-btn"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">BH-1001-BT</span></span>
                            <span class="posted_in">Category: <a href="index.php?page=shop"> sports, gaming, music
                                    listening</a></span>
                            <span>Tags: <a href="index.php?page=shop">Wireless</a><a href="index.php?page=shop">Sports</a></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="th-product">
                                <div class="product-img">
                                    ...
                                    <div class="actions">
                                        ...
                                        <a href="index.php?page=cart" class="icon-btn"><i class="far fa-cart-plus"></i></a>
                                        <a href="index.php?page=wishlist" class="icon-btn"><i class="far fa-heart"></i></a>
                                    </div>
                                </div>
                                <div class="product-content">
                                    <span class="price">$250.00<del>$550.00</del></span>
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Flooring-Vinyl</a></h3>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Cement Metal Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Metal Roof Steel</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Roof Tiles Braas</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Ceramic Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Wall Formwork</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    <span class="price">$235.00</span>
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Flashing Roof</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
                        ...
                        <div class="swiper-slide style2">
                            <div class="th-product">
                                ...
                                <div class="product-content">
                                    <span class="price">$250.00<del>$550.00</del></span>
                                    <h3 class="product-title"><a href="index.php?page=shop_details">Roof Topwet</a></h3>
                                    <div class="woocommerce-product-rating">
                                        <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                            <span>Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span>
                                        </div>
