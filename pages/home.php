                    ...
                    <div class="swiper-slide">
                        <div class="destination-box gsap-cursor">
                            <div class="destination-img">
                                <img src="admin/destination/<?php echo htmlentities($result->PackageImage2);?>" alt="destination image">
                                <div class="destination-content">
                                    <div class="media-left">
                                        <h4 class="box-title">
                                            <a href="index.php?page=destination_details"><?php echo htmlentities($result->Topic);?></a>
                                        </h4>
                                    </div>
                                    <div class="">
...
==============================-->
    ...
    <?php include 'pages/testimonial_area.php'; ?>
    <?php include 'pages/brand_area.php'; ?>
<!--==============================
Blog Area  
==============================-->
