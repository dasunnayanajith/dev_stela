                    ...
                    <tbody>
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="index.php?page=shop-detailis"><img width="91" height="91" src="assets/img/product/product_1_1.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="index.php?page=shop-detailis">beach casual-shoe</a>
                            </td>
                            <td data-title="Price">
                        ...
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="index.php?page=shop-detailis"><img width="91" height="91" src="assets/img/product/product_1_2.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="index.php?page=shop-detailis">Beach football</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="index.php?page=shop-detailis"><img width="91" height="91" src="assets/img/product/product_1_3.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="index.php?page=shop-detailis">Hamok</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="actions">
                                ...
                                <a href="index.php?page=shop" class="th-btn">Continue Shopping</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="row justify-content-end">
                <div class="col-md-8 col-lg-7 col-xl-6">
                    ...
                    <div class="wc-proceed-to-checkout mb-30">
                        <a href="index.php?page=checkout" class="th-btn">Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>
